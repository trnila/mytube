...
c.height=255;b=c.getContext("2d");f=b.createLinearGradient(0,0,0,c.height);f.addColorStop(0,"red");f.addColorStop(0.5,"yellow");f.addColorStop(1,"green");b.fillStyle=f;a()}},!1);var d})();$(function(){$.nette.ext("history").cache=!1;$.nette.init()});$(function(){var a;$("#video-search input").keyup(function(e){var c=$(this);clearInterval(a);a=setTimeout(function(){c.addClass("loading");$.nette.ajax({},c.closest("form"),e).done(function(){c.removeClass("loading")})},100)})});
...
$.editable.types.text.element=function(a){var e=$('<input type="text" />');"none"!=a.width&&e.attr("width",a.width);"none"!=a.height&&e.attr("height",a.height);e.attr("autocomplete","off");$(this).append(e);return e};
function editable(a,e,c){c=$.extend({indicator:"Ukl\u00e1dam...",tooltip:"Klikni pro \u00fapravu",ajaxoptions:{dataType:"json"},callback:function(b){if(b.error){var c=a.attr("title");a.attr("title",null);a.popover("destroy");a.popover({animation:!0,title:"Chyba",placement:"bottom",delay:100,content:b.error});a.html(b.original);a.click();a.attr("title",c)}else a.popover("destroy"),a.html(b.value)}},c);a.editable(e,c)}
$(document).ready(function(){$(".editable").each(function(){var a=$(this);editable(a,a.closest("[data-editable-action]").attr("data-editable-action"),{type:a.data("editable-type")||"text",data:a.data("editable-data"),name:a.data("editable-name"),submitdata:{id:a.closest("[data-editable-id]").data("editable-id")}})})});
