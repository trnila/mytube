...
c.height=255;b=c.getContext("2d");f=b.createLinearGradient(0,0,0,c.height);f.addColorStop(0,"red");f.addColorStop(0.5,"yellow");f.addColorStop(1,"green");b.fillStyle=f;a()}},!1);var d})();$(function(){$.nette.ext("history").cache=!1;$.nette.init()});$(function(){var a;$("#video-search").keyup(function(e){var c=$(this);clearInterval(a);a=setTimeout(function(){1>!c.val().length||$.nette.ajax({},c.closest("form"),e)},100)})});
