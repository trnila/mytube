...
$(document).ready(function(){$(".editable").each(function(){var a=$(this),d="undefined"!=typeof a.data("editable-buttons");editable(a,a.closest("[data-editable-action]").attr("data-editable-action"),{type:a.data("editable-type")||"text",data:a.data("editable-data"),name:a.data("editable-name"),submitdata:{id:a.closest("[data-editable-id]").data("editable-id")},submit:d?'<button type="submit" class="btn btn-success">Ulo\u017eit</button>':null,cancel:d?'<button class="btn btn-danger">Zru\u0161it</button>':
null})})});$(function(){$.nette.ext("history").cache=!1;$.nette.init()});$(function(){var a;$("#video-search input").keyup(function(d){var c=$(this);clearInterval(a);a=setTimeout(function(){c.addClass("loading");$.nette.ajax({},c.closest("form"),d).done(function(){c.removeClass("loading")})},100)})});
